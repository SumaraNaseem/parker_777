...
<div className='border-b-2 w-20 border-yellow-400'></div>
</div>
<div className="my-12 mt-7  px-1 sm:px-2 lg:px-24 ">
    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-1">
